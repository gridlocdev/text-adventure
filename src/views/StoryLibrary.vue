  ...
  <v-container>
    ...
    <v-row>
      <v-col
        ...
        :key="story.StoryID"
      >
        <v-card class="pa-5 mx-auto" elevation="5">
          <v-list-item three-line>
            ...
            <v-avatar rounded color="primary darken-1" size="75">
              <v-icon color="white" x-large> mdi-{{ story.StoryIcon }} </v-icon>
            </v-avatar>
            <!-- <v-list-item-avatar rounded elevation="5" size="80">
              <v-icon color="white" x-large> mdi-{{ story.StoryIcon }} </v-icon>
            </v-list-item-avatar> -->
          </v-list-item>
          <h1></h1>
    ...
    <v-row class="my-5">
      ...
      <v-col align="center" justify="center">
        <v-btn
          @click="$router.push('storyCreator')"
          x-large
          color="primary"
          elevation="5"
        >
